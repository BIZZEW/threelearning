...
// playBtn.type = "button";
// playBtn.style = "position: absolute;padding: 10px;";
// playBtn.innerHTML = "暂停/继续";
// document.body.appendChild(playBtn);
// playBtn.onclick = playBack;

// var fastforwardBtn = document.createElement("button");
// fastforwardBtn.type = "button";
// fastforwardBtn.style = "position: absolute;padding: 10px;right:0;";
// fastforwardBtn.innerHTML = "快进";
...
sliderWrapper.setAttribute('id', 'app');
document.body.appendChild(sliderWrapper);

var MyComponent = Vue.extend({
    template: '<el-slider show-input :max=20 :step=0.01></el-slider>'
})
...
function fastforward() {
    ...
    // console.log("AnimationAction.time: " + AnimationAction.time + " , clip.duration: " + clip.duration);
